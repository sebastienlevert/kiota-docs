...
using System;
namespace PetStore.Store.Inventory {
    /// <summary>
...
#nullable restore
        ...
        public async Task<InventoryResponse> GetAsync(Action<InventoryRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<InventoryResponse>(requestInfo, InventoryResponse.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Returns a map of status codes to quantities
        /// </summary>
